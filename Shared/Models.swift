...
public typealias SDKSyncSessionProgress = @convention(block) (_ total: UInt64, _ current: UInt64, _ new: UInt64) -> Void

public typealias SDKSyncSessionBandwidth = @convention(block) (_ speed: UInt64) -> Void
...
public class SDKAccountDetails {
    ...
    public var notifications: [SDKSafeDriveNotification]?
    
    
    public required init(account_details: SDDKAccountDetails) {
        let n: [SDKSafeDriveNotification]? = nil
